...
from gedcom.validate.marriage_after_death import validate_marriage_after_death
...
def test_marriage_after_death():
    ...
    assert_equals(False, validate_marriage_after_death(individuals, families))
...
def test_marriage_before_death():
    ...
    assert_equals(True, validate_marriage_after_death(individuals, families))
